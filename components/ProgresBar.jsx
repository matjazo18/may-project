...
export default function ProgresBar({ finalDays }) {
  ...
  const opacityClass = `opacity-[${Math.round(result)}%]`;
      ...
      <div className="flex flex-col  justify-start items-start">
        ...
        <div className="flex gap-4">
          <div>
            <button
              onClick={changeDays}
              className=" px-6 py-0.5 bg-gray-800 text-slate-100 rounded-xl flex justify-center hover:scale-105 transition-300 transition-all"
            >
              add
            </button>
          </div>
